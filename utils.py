...
# from skimage.metrics.peak_signal_noise_ratio import compare_psnr
...
def remove_dataparallel_wrapper(state_dict):
	r"""Converts a DataParallel model to a normal one by removing the "module." wrapper in the module dictionary
