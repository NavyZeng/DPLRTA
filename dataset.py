...
def img_to_patches(img, win, stride=1):
	...
	Args:
		img: a numpy array containing a CxHxW RGB (C=3) or grayscale (C=1) image
...
def prepare_data(data_path,patch_size, stride, max_num_patches=None, aug_times=1, gray_mode=False):
